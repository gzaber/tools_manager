...
import 'package:tools_manager/domain/use_cases/tool_use_cases/count_tools_in_stock_by_user_use_case.dart';

import '../../../fake_repositories/fake_tool_repository.dart';
import 'package:async/async.dart';

void main() {
  late CountToolsInStockByUserUseCase sut;
  late FakeToolRepository fakeToolRepository;

  setUp(() {
    fakeToolRepository = FakeToolRepository();
    sut = CountToolsInStockByUserUseCase(fakeToolRepository);
  });

  group('CountToolsInStockByUserUseCase', () {
