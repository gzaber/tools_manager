...
import 'package:tools_manager/domain/use_cases/tool_use_cases/count_received_tools_by_user_use_case.dart';

import '../../../fake_repositories/fake_tool_repository.dart';
import 'package:async/async.dart';

void main() {
  late CountReceivedToolsByUserUseCase sut;
  late FakeToolRepository fakeToolRepository;

  setUp(() {
    fakeToolRepository = FakeToolRepository();
    sut = CountReceivedToolsByUserUseCase(fakeToolRepository);
  });

  group('CountReceivedToolsByUserUseCase', () {
