...
import 'package:tools_manager/domain/use_cases/common_use_cases/get_tools_in_tool_room_use_case.dart';

import '../../../fake_repositories/fake_tool_repository.dart';
import '../../../fake_repositories/fake_user_repository.dart';

void main() {
  late GetToolsInToolRoomUseCase sut;
  ...
  setUp(() {
    ...
    sut = GetToolsInToolRoomUseCase(fakeToolRepository, fakeUserRepository);
  });

  group('GetToolsInToolRoomUseCase', () {
